...
function k100k() {
  ...
  myPurchase.set('purchaseId', purchaseID);
  myPurchase.set('quantity', 1);
  myPurchase.set('purchaseItemName', 'http://butterflyexplosion/coins100K.html');

  myPurchase.save(null, {
    success: function(myPurchase) {
     // Execute any logic that should take place after the object is saved.
     console.log('New object created with objectId: ' + myPurchase.id);
    },
    error: function(myPurchase, error) {
